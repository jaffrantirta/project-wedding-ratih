...
export default function GroomBride() {
    return (
        <div className='bg-[url("/src/assets/images/NW5.png")] bg-primary bg-no-repeat bg-cover h-fit font-primary p-10 md:px-24 flex items-center justify-center'>
            <div className='bg-white bg-opacity-90 rounded-3xl'>
                <div className={`text-center p-10`}>
                    ...
                    <p className={`md:px-10`}>Atas Asung Kertha Wara Nugraha Ida Sang Hyang Widhi Wasa/Tuhan Yang Maha Esa kami bermaksud mengundang Bapak/Ibu/Saudara/i pada Upacara Manusa Yadnya Pawiwahan (Pernikahan) dan Mepandes (Potong Gigi) </p>
                    ...
                    <div className={`mt-10 flex justify-center`}>
                        <img alt='' src={ImgBorder3} className={``} />
                    </div>
                    <div className='grid grid-cols-1 md:grid-cols-2 mt-14'>
