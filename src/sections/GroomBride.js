        ...
        <div className='bg-[url("/src/assets/images/NW5.png")] bg-accentColor bg-no-repeat bg-contain h-fit font-primary p-10 md:px-24 flex items-center justify-center'>
            <div className='bg-white bg-opacity-90 rounded-3xl'>
                <div className={`text-center p-10`}>
                    ...
                    <img alt='' src={ImgOswastyastu} className={`w-1/2 md:w-1/6 mx-auto`} />
                    <p className={`md:px-10 my-5`}>Atas Asung Kertha Wara Nugraha Ida Sang Hyang Widhi Wasa/Tuhan Yang Maha Esa kami bermaksud mengundang Bapak/Ibu/Saudara/i pada Upacara Manusa Yadnya Pawiwahan (Pernikahan) dan Mepandes (Potong Gigi) </p>
