...
export default function Mepandes() {
    return (
        <div className='h-fit bg-primary font-primary p-10'>
            <div className='flex justify-center'>
                <img alt='' src={ImgOrnamentWhite1} className={`md:w-1/4 w-1/2 h-auto`} />
            </div>
            <h1 className='text-5xl text-white font-third text-center mt-2'>Mepandes</h1>
            <div className='grid grid-cols-1 md:grid-cols-2 p-10 mt-10 rounded-3xl bg-white bg-opacity-90 gap-10'>
                <div className='mx-auto'>
                    ...
                    <h1 className='text-2xl text-center font-third text-accentColor'>Luh Ade Metha Dian Rahayu</h1>
                </div>
                <div className='mx-auto'>
                    <div className='flex justify-center'>
                        <img alt='ocha-images'
                    ...
                    <h1 className='text-2xl text-center font-third text-accentColor'>Luh Komang Ocha Dian Rahayu</h1>
                </div>
            </div>
        </div>
    )
