...
export default function DetailEvents() {
    return (
        <div className='bg-primary h-fit font-primary p-10'>
            <div className='bg-white bg-opacity-80 rounded-3xl p-10'>
                <div className='grid grid-cols-4 md:grid-cols-3 justify-center place-items-center'>
                    ...
                    <h1 className='text-2xl md:text-6xl font-third text-center text-accentColor col-span-2 md:col-span-1 row-span-3 md:row-span-1'>Detail Acara</h1>
                ...
                <h1 className='text-center text-3xl mt-5 text-accentColor'>Sabtu</h1>
                <div className='grid grid-cols-3 gap-10 md:px-64 mt-10 text-accentColor'>
